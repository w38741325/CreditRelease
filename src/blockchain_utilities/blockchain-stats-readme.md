# Credit Blockchain Stats

Credit Blockchain Stats exports daily statistics for the Credit blockchain from creation through the current state.

## Usage:

See also the utility's help option. `credit-blockchain-stats --help`
...
- `credit-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `credit-blockchain-stats | save-to-database.sh`
